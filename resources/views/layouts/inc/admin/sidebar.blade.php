 <!-- Sidebar -->
    <div class="sidebar">
        ...
        <ul class="side-menu">
            ...
            <li><a href="#"><i class='bx bx-message-square-dots'></i>Audits/Claims</a></li>
            <li><a  id="subMenu" style="opacity:" href=" {{ url('/admin/expenses') }}"></i>Expenses</a></li>
            <li><a  id="subMenu" style="opacity:" href=" {{ url('/admin/warehouse') }}"></i>Warehouse</a></li>
            <li><a  id="subMenu" style="opacity:" href=" {{ url('/admin/claims') }}"></i>Claims</a></li>
